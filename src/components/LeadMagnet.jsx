...
export default function LeadMagnet() {
  return (
    <Section id="checklist" spacing="pt-4 pb-16 md:pb-20">
      <div className="rounded-3xl bg-brand-600 text-white shadow-lift px-6 py-7 md:px-10 md:py-9 grid gap-6 md:grid-cols-[1.4fr_auto] md:items-center">
        <div>
          <h2 className="font-display text-xl md:text-2xl font-bold leading-snug">
            <span className="mr-2">🎁</span>Checklist gratis para tu web
          </h2>
          <p className="mt-1.5 text-sm text-brand-100 leading-relaxed max-w-lg">
        ...
        <a
          ...
          className="inline-flex flex-shrink-0 items-center justify-center gap-2 bg-white text-brand-600 font-semibold px-6 py-3.5 rounded-xl text-sm hover:bg-brand-50 transition-all shadow-md"
        >
